    ...
    window.Framework7 = function (a) {
        ...
        var p = function (e, a) {
            ...
            if (s.handleTouchStart = function (e) {
                    ...
                    z.transitionEnd(function () {
                        o([z[0], D[0]]).removeClass("page-transitioning"), P && (y.removeClass("page-transitioning").css({
                            opacity: ""
        ...
        var d = function (e, a) {
            ...
            s.setCancelButtonMargin = function () {
                ...
                var a = s.value;
                s.input.val("").trigger("change").focus(), s.triggerEvent("clearSearch searchbar:clear", "onClear", {
                    previousQuery: a
                })
        ...
        i.triggerPageCallbacks = function (e, a, t) {
            ...
            if (t && (!t.f7PageInitialized || !e || e.params.domCache)) {
                ...
                if (a.fromPage && !a.fromPage.navbarInnerContainer && a.oldNavbarInnerContainer && (a.fromPage.navbarInnerContainer = a.oldNavbarInnerContainer),
            ...
            var n, r, s, l, p, d, c, u, m, f = a.url,
                ...
                T = a.pushState,
                k = a.pageElement;
            if ("undefined" == typeof y && (y = e.params.animatePages), (i.params.template7Pages && "string" == typeof h || v) && (g = i.router.template7Render(e, a), g.content && !h && (h = g.content)), i.router.temporaryDom.innerHTML = "", !b && !k)
            ...
            if (k && r.length > 1 && (r = r.filter(function (e, a) {
                ...
                if (u = !0, d = b ? w.find('.navbar-inner[data-page="' + b + '"]') : i.router.findElement(".navbar-inner", i.router.temporaryDom, e), d && 0 !== d.length || (d = n.find(".navbar-inner"), d && 0 !== d.length ? d.parent(".navbar").length > 0 && d.prependTo(n) : u = !1), u && n.find(".navbar").length > 0 && i.router._remove(n.find(".navbar").filter(function (e, a) {
                        return 0 === o(a).parents(i.router._modalsSelector).length
            ...
            if (e.params.uniqueHistory) {
                ...
                if (e.params.uniqueHistoryIgnoreGetParameters)
                    for (z = [], D = f.split("?")[0], l = 0; l < e.history.length; l++) z.push(e.history[l].split("?")[0]);
        ...
        i.modalStack = [], i.modalStackClearQueue = function () {
            ...
            var n, r, s, p = !1;
            1 === arguments.length || 2 === arguments.length && "boolean" == typeof arguments[1] ? (a = arguments[0], t = arguments[1]) : i.device.ios ? i.device.ipad && (p = !0) : o(window).width() >= 768 && (p = !0), "undefined" == typeof t && (t = !0), a = a || [], a.length > 0 && !o.isArray(a[0]) && (a = [a]);
            var d;
            if (p) {
                ...
                if (i.params.modalActionsTemplate) i._compiledTemplates.actions || (i._compiledTemplates.actions = l.compile(i.params.modalActionsTemplate)), d = i._compiledTemplates.actions(a);
                else {
            ...
            function r() {
                ...
                var t, n, r, i = e.width(),
                    s = e.height(),
                    p = 0;
                l ? e.removeClass("popover-on-left popover-on-right popover-on-top popover-on-bottom").css({
                    left: "",
                    top: ""
                ...
                var f = o(window).height(),
                    ...
                    w = l ? "bottom" : "top";
                if (l) {
                    if (s < f - u.top - c ? (w = "bottom", g = u.top) : s < u.top ? (g = u.top - s + c, w = "top") : (w = "bottom", g = u.top), g <= 0 ? g = 8 : g + s >= f && (g = f - s - 8), v = u.left, v + i >= h - 8 && (v = u.left + d - i - 8), v < 8 && (v = 8), "top" === w && e.addClass("popover-on-top"), "bottom" === w && e.addClass("popover-on-bottom"), a.hasClass("floating-button-to-popover") && !e.hasClass("modal-in")) {
                        ...
                        a.addClass("floating-button-to-popover-in").transform("translate3d(" + C + "px, " + y + "px,0)").transitionEnd(function (e) {
                            a.hasClass("floating-button-to-popover-in") && a.addClass("floating-button-to-popover-scale").transform("translate3d(" + C + "px, " + y + "px,0) scale(" + i / d + ", " + s / c + ")")
                ...
                } else s + p < u.top ? g = u.top - s - p : s + p < f - u.top - c ? (w = "bottom", g = u.top + c + p) : (w = "middle", g = c / 2 + u.top - s / 2, b = g, g <= 0 ? g = 5 : g + s >= f && (g = f - s - 5), b -= g), "top" === w || "bottom" === w ? (v = d / 2 + u.left - i / 2, b = v, v < 5 && (v = 5), v + i > h && (v = h - i - 5), "top" === w && t.addClass("on-bottom"), "bottom" === w && t.addClass("on-top"), b -= v, n = i / 2 - p + b, n = Math.max(Math.min(n, i - 2 * p - 13), 13), t.css({
                    left: n + "px"
                })) : "middle" === w && (v = u.left - i - p, t.addClass("on-right"), (v < 5 || v + i > h) && (v < 5 && (v = u.left + d + p), v + i > h && (v = h - i - 5), t.removeClass("on-right").addClass("on-left")), r = s / 2 - p + b, r = Math.max(Math.min(r, s - 2 * p - 13), 13), t.css({
                    top: r + "px"
                }));
                e.css({
                    top: g + "px",
            ...
            if ("undefined" == typeof t && (t = !0), "undefined" == typeof n && (n = !0), "string" == typeof e && e.indexOf("<") >= 0) {
                var s = document.createElement("div");
                if (s.innerHTML = e.trim(), !(s.childNodes.length > 0)) return !1;
                e = s.childNodes[0], t && e.classList.add("remove-on-close"), i.root.append(e)
            }
            ...
            return r(), o(window).on("resize", r), e.on("popover:close", function () {
            ...
            if ("undefined" == typeof a && (a = !0), e = o(e || ".modal-in"), "undefined" == typeof e || 0 !== e.length) {
                ...
                var c, u = e.hasClass("remove-on-close"),
                ...
                return r ? c = o(".popup-overlay") : l && i.params.material ? c = o(".picker-modal-overlay") : l || (c = o(".modal-overlay")), r ? e.length === o(".popup.modal-in").length && c.removeClass("modal-overlay-visible") : c && c.length > 0 && c.removeClass("modal-overlay-visible"), c && c[a ? "removeClass" : "addClass"]("not-animated"), e.trigger("close " + d + ":close"), l && (o("body").removeClass("with-picker-modal"), o("body").addClass("picker-modal-closing")), !n || i.params.material ? (a ? e.removeClass("modal-in").addClass("modal-out").transitionEnd(function (a) {
                    ...
                    l && o("body").removeClass("picker-modal-closing"), r || s || l || n ? (e.removeClass("modal-out").hide(), u && e.length > 0 && e.remove()) : m || e.remove()
                }) : (e.trigger("closed " + d + ":closed"), e.removeClass("modal-in modal-out"), l && o("body").removeClass("picker-modal-closing"), r || s || l || n ? (e.hide(), u && e.length > 0 && e.remove()) : m || e.remove()), t && i.params.modalStack && i.modalStackClearQueue()) : (e.removeClass("modal-in modal-out not-animated").trigger("closed " + d + ":closed").hide(), u && e.remove()), !0
            }
            ...
            function t() {
                s.transitionEnd(function (e) {
                    o(e.target).is(s) ? (n.hasClass("active") ? n.trigger("opened panel:opened") : n.trigger("closed panel:closed"), i.params.material && o(".panel-overlay").css({
                        display: ""
                    }), i.allowPanelOpen = !0) : t()
                })
            }
            ...
            n[a ? "removeClass" : "addClass"]("not-animated"), n.css({
                display: "block"
            }).addClass("active"), n.trigger("open panel:open"), i.params.material && (o(".panel-overlay")[a ? "removeClass" : "addClass"]("not-animated"), o(".panel-overlay").show()), n.find("." + i.params.viewClass).length > 0 && i.sizeNavbars && i.sizeNavbars(n.find("." + i.params.viewClass)[0]);
            var s = (n[0].clientLeft, "reveal" === r ? o("." + i.params.viewsClass) : n);
            return a ? t() : (n.trigger("opened panel:opened"), i.params.material && o(".panel-overlay").css({
                display: ""
            }), i.allowPanelOpen = !0), o("body").addClass("with-panel-" + e + "-" + r), !0
            ...
            a[e ? "removeClass" : "addClass"]("not-animated"), a.removeClass("active"), i.params.material && o(".panel-overlay").removeClass("not-animated");
            var r = "reveal" === t ? o("." + i.params.viewsClass) : a;
            a.trigger("close panel:close"), i.allowPanelOpen = !1, e ? (r.transitionEnd(function () {
                a.hasClass("active") || (a.css({
                    display: ""
                }), a.trigger("closed panel:closed"), o("body").removeClass("panel-closing"), i.allowPanelOpen = !0)
            }), o("body").addClass("panel-closing").removeClass("with-panel-" + n + "-" + t)) : (a.css({
                display: ""
            }), a.trigger("closed panel:closed"), a.removeClass("not-animated"), o("body").removeClass("with-panel-" + n + "-" + t), i.allowPanelOpen = !0)
            ...
            function a(e) {
                if (s && !e.f7PreventPanelSwipe) {
                    ...
                    "right" === r && (x = -x), c = a - w.x + x, "right" === r ? (u = c - (f ? h : 0), u > 0 && (u = 0), u < -h && (u = -h)) : (u = c + (f ? h : 0), u < 0 && (u = 0), u > h && (u = h)), "reveal" === g ? (C.transform("translate3d(" + u + "px,0,0)").transition(0), b.transform("translate3d(" + u + "px,0,0)").transition(0), n.trigger("panel:swipe", {
                        progress: Math.abs(u / h)
                    }), i.pluginHook("swipePanelSetTransform", C[0], n[0], Math.abs(u / h))) : (n.transform("translate3d(" + u + "px,0,0)").transition(0), i.params.material && (b.transition(0), m = Math.abs(u / h), b.css({
                        opacity: m
            ...
            function a(e) {
                function t() {
                    e.removeClass("lazy").addClass("lazy-loaded"), r ? e.css("background-image", "url(" + s + ")") : e.attr("src", s), i.params.imagesLazyLoadSequential && (u = !1, c.length > 0 && a(c.shift()))
                }

                function n() {
                    e.removeClass("lazy").addClass("lazy-loaded"), r ? e.css("background-image", "url(" + d + ")") : e.attr("src", d), i.params.imagesLazyLoadSequential && (u = !1, c.length > 0 && a(c.shift()))
                }
                e = o(e);
        ...
        i.messages = function (e, a) {
            ...
            function t(e) {
                if (r) {
                    ...
                    var z;
                    if (m.length > 0)
                        for (O = v / g, v < -g && (v = -g - Math.pow(-v - g, .8), k.length > 0 && (S = !0)), n = 0; n < y.length; n++) "undefined" == typeof y[n]._buttonOffset && (y[n]._buttonOffset = y[n].offsetLeft), p = y[n]._buttonOffset, z = o(y[n]), k.length > 0 && z.hasClass("swipeout-overswipe") && (z.css({
                            left: (S ? -p : 0) + "px"
                        }), S ? z.addClass("swipeout-overswipe-active") : z.removeClass("swipeout-overswipe-active")), z.transform("translate3d(" + (v - p * (1 + Math.max(O, -1))) + "px,0,0)");
                    if (f.length > 0)
                        for (O = v / h, v > h && (v = h + Math.pow(v - h, .8), T.length > 0 && (P = !0)), n = 0; n < C.length; n++) "undefined" == typeof C[n]._buttonOffset && (C[n]._buttonOffset = h - C[n].offsetLeft - C[n].offsetWidth), p = C[n]._buttonOffset, z = o(C[n]), T.length > 0 && z.hasClass("swipeout-overswipe") && (z.css({
                            left: (P ? p : 0) + "px"
                        }), P ? z.addClass("swipeout-overswipe-active") : z.removeClass("swipeout-overswipe-active")), C.length > 1 && z.css("z-index", C.length - n), z.transform("translate3d(" + (v + p * (1 - Math.min(O, 1))) + "px,0,0)");
            ...
            function n(e) {
                ...
                if (n = "to-left" === x ? m : f, t = "to-left" === x ? g : h, a = T < 300 && (d < -10 && "to-left" === x || d > 10 && "to-right" === x) || T >= 300 && Math.abs(v) > t / 2 ? "open" : "close", T < 300 && (0 === Math.abs(v) && (a = "close"), Math.abs(v) === t && (a = "open")), "open" === a) {
                    ...
                    var k = "to-left" === x ? -t : t;
                    if (u.transform("translate3d(" + k + "px,0,0)"), n.addClass("swipeout-actions-opened"), l = "to-left" === x ? y : C)
                        for (w = 0; w < l.length; w++) o(l[w]).transform("translate3d(" + k + "px,0,0)");
                ...
                var M;
                if (C && C.length > 0 && C !== l)
                    for (w = 0; w < C.length; w++) M = C[w]._buttonOffset, "undefined" == typeof M && (C[w]._buttonOffset = h - C[w].offsetLeft - C[w].offsetWidth), o(C[w]).transform("translate3d(" + M + "px,0,0)");
                if (y && y.length > 0 && y !== l)
                    for (w = 0; w < y.length; w++) M = y[w]._buttonOffset, "undefined" == typeof M && (y[w]._buttonOffset = y[w].offsetLeft), o(y[w]).transform("translate3d(" + -M + "px,0,0)");
            ...
            a = e.is(".smart-select") ? e : e.find(".smart-select"), 0 !== a.length && a.each(function () {
                ...
                if (0 !== a.length) {
                    ...
                    if (0 !== t.length) {
                        ...
                        if (0 === s.length) e.find(".item-inner").append('<div class="item-after">' + r.join(", ") + "</div>");
                        else {
                            var l = s.text();
                            if (s.hasClass("smart-select-value"))
                                for (i = 0; i < t.length; i++) t[i].selected = t[i].textContent.trim() === l.trim();
                            else s.text(r.join(", "))
                        }
        ...
        var g = function (e, a) {
            ...
            return r.setListSize = function () {
                ...
                if ("undefined" != typeof a && (t = a), null === r.lastRepaintY || Math.abs(t - r.lastRepaintY) > h || !s && r.pageContent[0].scrollTop + p >= r.pageContent[0].scrollHeight) {
                    ...
                    for (var w = n; w < i; w++) {
                        var C, y;
                        y = r.items.indexOf(o[w]), w === n && (r.currentFromIndex = y), w === i - 1 && (r.currentToIndex = y), r.filteredItems ? r.items[y] === r.filteredItems[r.filteredItems.length - 1] && (r.reachEnd = !0) : y === r.items.length - 1 && (r.reachEnd = !0), r.domCache[y] ? C = r.domCache[y] : (r.template && !r.params.renderItem ? r.tempDomElement.innerHTML = r.template(o[w], {
                            index: y
                        }).trim() : r.params.renderItem ? r.tempDomElement.innerHTML = r.params.renderItem(y, o[w]).trim() : r.tempDomElement.innerHTML = o[w].toString().trim(), C = r.tempDomElement.childNodes[0], r.params.cache && (r.domCache[y] = C)), C.f7VirtualListIndex = y, w === n && (b = g ? l : w * r.params.height / r.params.cols), C.style.top = b + "px", r.params.onItemBeforeInsert && r.params.onItemBeforeInsert(r, C), r.fragment.appendChild(C)
                    }
                ...
                var a = e ? "off" : "on";
                r.pageContent[a]("scroll", r.handleScroll), r.listBlock.parents(".tab").eq(0)[a]("tab:show", r.handleResize), r.listBlock.parents(".panel").eq(0)[a]("panel:open", r.handleResize), r.listBlock.parents(".popup").eq(0)[a]("popup:open", r.handleResize), o(window)[a]("resize", r.handleResize)
            }, r.init = function () {
        ...
        i.virtualList = function (e, a) {
            ...
            if (e = o(e), a = a || e.find(".tab-link.active"), a && a.length > 0) {
                var t, n;
                e.hasClass("tabbar-scrollable") ? (t = a[0].offsetWidth + "px", n = a[0].offsetLeft + "px") : (t = 1 / e.find(".tab-link").length * 100 + "%", n = 100 * (i.rtl ? -a.index() : a.index()) + "%"), e.find(".tab-link-highlight").css({
                    width: t
            ...
            e = o(e);
            var t = e.find(".tabbar");
            0 === t.length && e.hasClass("tabbar") && (t = e), t.length > 0 && (0 === t.find(".tab-link-highlight").length && t.find(".toolbar-inner").append('<span class="tab-link-highlight"></span>'), a(), o(window).on("resize", a), e.once("page:beforeremove", function () {
            ...
            function T(e) {
                ...
                if (i.params.activeState && (t(),
                        setTimeout(n, 0)), i.params.material && i.params.materialRipple && w(), p(E)) {
        ...
        var b = function (e) {
            ...
            if (!r.params.input || (r.input = o(r.params.input), 0 !== r.input.length || "dropdown" !== r.params.openIn)) {
                ...
                } else r.dropdownItemTemplate = l.compile(r.params.dropdownItemTemplate || '<li><label class="{{#unless placeholder}}label-radio{{/unless}} item-content" data-value="{{value}}"><div class="item-inner"><div class="item-title">{{text}}</div></div></label></li>'),
                ...
                return r.popup = void 0, r.dropdown = void 0, r.positionDropDown = function () {
                    ...
                    function a(e) {
                        if (r.params.source) {
                            ...
                            r.params.source(r, e, function (n) {
                                var i = "",
                                    o = r.params.limit ? Math.min(r.params.limit, n.length) : n.length;
                                for (r.items = n, a = 0; a < o; a++) {
                                    var l = !1,
                                        p = "object" == typeof n[a] ? n[a][r.params.valueProperty] : n[a];
                    ...
                    var n = e.detail.page;
                    if (r.page = o(n.container), r.pageData = n, n.name === g) {
                        var s = o(n.container),
                        ...
                        r.searchbar = l, s.on("change", 'input[type="radio"], input[type="checkbox"]', function () {
                            var e, a, n, s, l = this,
                                p = l.value,
                            ...
                            if (c) {
                                ...
                                for (e = 0; e < r.items.length; e++) n = "string" == typeof r.items[e] ? r.items[e] : r.items[e][r.params.valueProperty], n !== p && 1 * n !== 1 * p || (a = r.items[e]);
                                if ("radio" === r.inputType) r.value = [a];
                                else if (l.checked) r.value.push(a);
                                else
                                    for (e = 0; e < r.value.length; e++) s = "string" == typeof r.value[e] ? r.value[e] : r.value[e][r.params.valueProperty], s !== p && 1 * s !== 1 * p || r.value.splice(e, 1);
                                t(), ("radio" === r.inputType && l.checked || "checkbox" === r.inputType) && r.params.onChange && r.params.onChange(r, r.value), u && "radio" === r.inputType && ("popup" === r.params.openIn ? i.closeModal(r.popup) : d.router.back())
                            }
        ...
        var w = function (e) {
            ...
            return p.setValue = function (e, a) {
                ...
                var a, t = e || [],
                    n = [];
                if (0 === p.cols.length)
                    for (a = 0; a < p.params.cols.length; a++) void 0 !== p.params.cols[a].displayValues ? n.push(p.params.cols[a].displayValues[t[a]]) : n.push(t[a]);
                else
                    for (a = 0; a < p.cols.length; a++) p.cols[a].divider || (t.push(p.cols[a].value), n.push(p.cols[a].displayValue));
                t.indexOf(void 0) >= 0 || (p.value = t, p.displayValue = n, p.params.onChange && p.params.onChange(p, p.value, p.displayValue), p.input && p.input.length > 0 && (o(p.input).val(p.params.formatValue ? p.params.formatValue(p, p.value, p.displayValue) : p.value.join(" ")), o(p.input).trigger("change")))
                    ...
                    if (T) {
                        ...
                        if (0 === a.length && o(e.target).hasClass("picker-calendar-day") && (a = o(e.target)), 0 !== a.length && !a.hasClass("picker-calendar-day-disabled")) {
                            ...
                            var t = a.attr("data-year"),
                                n = a.attr("data-month"),
                                r = a.attr("data-day");
                            p.params.onDayClick && p.params.onDayClick(p, a[0], t, n, r), (!a.hasClass("picker-calendar-day-selected") || p.params.multiple || p.params.rangePicker) && p.addValue(new Date(t, n, r).getTime()), p.params.closeOnSelect && (p.params.rangePicker && 2 === p.value.length || !p.params.rangePicker) && p.close()
                        }
                    }
                }
        ...
        e.prototype = {
                ...
                append: function () {
                    ...
                    for (n = 0; n < arguments.length; n++)
                        ...
                        for (t = 0; t < r.length; t++) this[a].appendChild(r[t]);
        ...
        a.ajax = function (e) {
                ...
                if ("json" === e.dataType && e.url.indexOf("callback=") >= 0) {
                    ...
                    return h.type = "text/javascript", h.onerror = function () {
                        clearTimeout(d), r(void 0, void 0, "error", null, "scripterror"), r("ajaxComplete ajax:complete", {
                            scripterror: !0
                ...
                return g.onload = function (a) {
                    ...
                    T && clearTimeout(T), r("ajaxError ajax:error", {
                        xhr: g
                    }, "error", g, g.status), r("ajaxComplete ajax:complete", {
                        xhr: g
                    }, "complete", g, g.status)
            ...
            function () {
                ...
                if ("string" == typeof e && e.length)
                    for (e = e.indexOf("?") > -1 ? e.replace(/\S*\?/, "") : "", t = e.split("&"), r = t.length, a = 0; a < r; a++) n = t[a].replace(/#\S+/g, "").split("="), i[decodeURIComponent(n[0])] = decodeURIComponent(n[1]) || "";
                return i
                ...
                if ("object" == typeof t && n)
                    if (a.isArray(t) || t instanceof e) {
                        ...
                        var i;
                        for (i in t)
                            if (t.hasOwnProperty(i) && n(i, t[i]) === !1) return
                    }
            }, a.unique = function (e) {
        ...
        if (v.params = n, v.originalParams = u, v.classNames = [], "undefined" != typeof a && "undefined" != typeof e && (a = e), ("undefined" != typeof a || (a = "undefined" == typeof e ? window.Dom7 || window.Zepto || window.jQuery : e)) && (v.$ = a, v.currentBreakpoint = void 0, v.getActiveBreakpoint = function () {
            ...
            v.container[0].swiper = v, v.container.data("swiper", v), v.classNames.push(v.params.containerModifierClass + v.params.direction), v.params.freeMode && v.classNames.push(v.params.containerModifierClass + "free-mode"), v.support.flexbox || (v.classNames.push(v.params.containerModifierClass + "no-flexbox"), v.params.slidesPerColumn = 1), v.params.autoHeight && v.classNames.push(v.params.containerModifierClass + "autoheight"), (v.params.parallax || v.params.watchSlidesVisibility) && (v.params.watchSlidesProgress = !0), v.params.touchReleaseOnEdges && (v.params.resistanceRatio = 0), ["cube", "coverflow", "flip"].indexOf(v.params.effect) >= 0 && (v.support.transforms3d ? (v.params.watchSlidesProgress = !0, v.classNames.push(v.params.containerModifierClass + "3d")) : v.params.effect = "slide"), "slide" !== v.params.effect && v.classNames.push(v.params.containerModifierClass + v.params.effect), "cube" === v.params.effect && (v.params.resistanceRatio = 0, v.params.slidesPerView = 1, v.params.slidesPerColumn = 1, v.params.slidesPerGroup = 1, v.params.centeredSlides = !1, v.params.spaceBetween = 0, v.params.virtualTranslate = !0, v.params.setWrapperSize = !1), "fade" !== v.params.effect && "flip" !== v.params.effect || (v.params.slidesPerView = 1, v.params.slidesPerColumn = 1, v.params.slidesPerGroup = 1, v.params.watchSlidesProgress = !0, v.params.spaceBetween = 0, v.params.setWrapperSize = !1, "undefined" == typeof c && (v.params.virtualTranslate = !0)), v.params.grabCursor && v.support.touch && (v.params.grabCursor = !1), v.wrapper = v.container.children("." + v.params.wrapperClass), v.params.pagination && (v.paginationContainer = a(v.params.pagination), v.params.uniqueNavElements && "string" == typeof v.params.pagination && v.paginationContainer.length > 1 && 1 === v.container.find(v.params.pagination).length && (v.paginationContainer = v.container.find(v.params.pagination)), "bullets" === v.params.paginationType && v.params.paginationClickable ? v.paginationContainer.addClass(v.params.paginationModifierClass + "clickable") : v.params.paginationClickable = !1, v.paginationContainer.addClass(v.params.paginationModifierClass + v.params.paginationType)), (v.params.nextButton || v.params.prevButton) && (v.params.nextButton && (v.nextButton = a(v.params.nextButton), v.params.uniqueNavElements && "string" == typeof v.params.nextButton && v.nextButton.length > 1 && 1 === v.container.find(v.params.nextButton).length && (v.nextButton = v.container.find(v.params.nextButton))), v.params.prevButton && (v.prevButton = a(v.params.prevButton), v.params.uniqueNavElements && "string" == typeof v.params.prevButton && v.prevButton.length > 1 && 1 === v.container.find(v.params.prevButton).length && (v.prevButton = v.container.find(v.params.prevButton)))), v.isHorizontal = function () {
                ...
                var a = v.maxTranslate() - v.minTranslate(),
                    t = v.isBeginning,
                    n = v.isEnd;
                0 === a ? (v.progress = 0, v.isBeginning = v.isEnd = !0) : (v.progress = (e - v.minTranslate()) / a, v.isBeginning = v.progress <= 0,
                    v.isEnd = v.progress >= 1), v.isBeginning && !t && v.emit("onReachBeginning", v), v.isEnd && !n && v.emit("onReachEnd", v), v.params.watchSlidesProgress && v.updateSlidesProgress(e), v.emit("onProgress", v, v.progress)
            ...
            v.onTouchStart = function (e) {
                ...
                if (e.originalEvent && (e = e.originalEvent), !D || "mousemove" !== e.type) {
                    ...
                    if (D && v.params.touchReleaseOnEdges && !v.params.loop)
                        if (v.isHorizontal()) {
