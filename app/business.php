    ...
    <div id="vue" ref="vue" class="vue">
        ...
        <div class="likes">
            <span>
                ...
                <!-- <img class="img" :src="detail.avatar"> -->
            </span>
        ...
        <div class="tips">
            ...
            <div class="tips-content" v-text="'藏玉买卖旨在给玉友提供一个免费的宝贝交流与展示的平台。对于广大玉友发布的买卖帖子，藏玉众选官方会依据发布的图片内容给出专业建议，仅供玉友参考。'"></div>
        </div>
