...
<body>
	<div ref="vue" id="vue" class="vue">
		...
		<div class="detail">
			...
			<div ref="album" id="album" class="album">
				<img class="img background" v-for="(item, index) in detail.album" :key="index" @click="bigImg(item.file_path)" :style="content.length>5?'margin-bottom:10px':''" :src="item.file_path"></img>
			</div>
		</div>
		<!-- Bottom Tabbar-->
