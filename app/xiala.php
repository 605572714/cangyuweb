...
<head>
    ...
    <script type="text/javascript">
        ...
        function loaded() {
            pullDownEl = document.getElementById('pullDown'); // 下拉标签
            pullDownOffset = pullDownEl.offsetHeight; // 下拉高度
            pullUpEl = document.getElementById('pullUp'); // 上拉标签
            pullUpOffset = pullUpEl.offsetHeight; // 上拉高度
