...
! function (t, i) {
    ...
    var s = {
        ...
        W = t ? "pointerup pointercancel" : h ? "touchend touchcancel" : "mouseup",
        P = "ready",
        A = "resize",
        j = "show",
        H = "shown",
        ...
        Tt = {
            ...
            unbind: function () {
                var t = this.options,
                    ...
                    e = this.canvas,
                    n = this.element.ownerDocument;
                vt(i, C, this.onClick), vt(i, N, this.onDragStart), vt(e, X, this.onPointerDown), vt(n, F, this.onPointerMove), vt(n, W, this.onPointerUp), vt(n, Y, this.onKeyDown), vt(window, A, this.onResize), t.zoomable && t.zoomOnWheel && vt(i, "wheel", this.onWheel, {
                    passive: !1,
                    capture: !0
        ...
        Et = {
            ...
            load: function () {
                ...
                lt(n, D), e.loading && lt(this.canvas, T), n.style.cssText = "height:0;" + "margin-left:".concat(o.width / 2, "px;") + "margin-top:".concat(o.height / 2, "px;") + "max-width:none!important;position:absolute;width:0;", this.initImage(function () {
                    ct(n, E, e.movable), ct(n, S, e.transition), t.renderImage(function () {
            ...
            pointerdown: function (t) {
                ...
                if (!(!this.viewed || this.showing || this.viewing || this.hiding || ("mousedown" === t.type || "pointerdown" === t.type && "mouse" === t.pointerType) && (G(n) && 1 !== n || G(s) && 0 !== s || t.ctrlKey))) {
                    ...
                    var o = !!i.movable && l;
                    i.zoomOnTouch && i.zoomable && 1 < Object.keys(e).length ? o = u : i.slideOnTouch && ("touch" === t.pointerType || "touchstart" === t.type) && this.isSwitchable() && (o = c), !i.transition || o !== l && o !== u || lt(this.image, S), this.action = o
                }
            },
        ...
        It = {
            show: function (t) {
                ...
                if (lt(s, k), n.transition && !i) {
                    ...
                    }, ht(s, S), s.initialOffsetWidth = s.offsetWidth, pt(s, V, o, {
                        once: !0
                    }), ht(s, z)
            ...
            hide: function () {
                ...
                if (e.transition && !t) {
                    ...
                    }, this.viewed && rt(this.image, S) ? (pt(this.image, V, o, {
                        once: !0
            ...
            play: function () {
                ...
                var s = this.options,
                    ...
                    h = 0,
                    l = 0;
                if (this.played = !0, this.onLoadWhenPlay = a, t && this.requestFullscreen(), ht(o, O), nt(this.items, function (t, i) {
                        var e = t.querySelector("img"),
                            n = document.createElement("img");
                        n.src = mt(e, "originalUrl"), n.alt = e.getAttribute("alt"), h += 1, ht(n, b), ct(n, S, s.transition), rt(t, f) && (ht(n, z), l = i), r.push(n), pt(n, q, a, {
                            once: !0
                        }), o.appendChild(n)
            ...
            stop: function () {
                ...
                }), lt(t, O), t.innerHTML = "", this.exitFullscreen(), this
            },
            full: function () {
                var t = this,
                    i = this.options,
                    ...
                    n = this.image,
                    s = this.list;
                return !this.isShown || this.played || this.fulled || !i.inline || (this.fulled = !0, this.open(), ht(this.button, d), i.transition && (lt(s, S), this.viewed && lt(n, S)), ht(e, y), e.setAttribute("style", ""), at(e, {
                    zIndex: i.zIndex
            ...
            exit: function () {
                var t = this,
                    ...
                    n = this.image,
                    s = this.list;
                return this.isShown && !this.played && this.fulled && i.inline && (this.fulled = !1, this.close(), lt(this.button, d), i.transition && (lt(s, S), this.viewed && lt(n, S)), lt(e, y), at(e, {
            ...
            tooltip: function () {
                var t = this,
                    ...
                    e = this.tooltipBox,
                    n = this.imageData;
                return this.viewed && !this.played && i.tooltip && (e.textContent = "".concat(Math.round(100 * n.ratio), "%"), this.tooltipping ? clearTimeout(this.tooltipping) : i.transition ? (this.fading && wt(e, V), ht(e, O), ht(e, b), ht(e, S), e.initialOffsetWidth = e.offsetWidth, ht(e, z)) : ht(e, O), this.tooltipping = setTimeout(function () {
                    i.transition ? (pt(e, V, function () {
                        lt(e, O), lt(e, b), lt(e, S), t.fading = !1
                    }, {
                        once: !0
                    }), lt(e, z), t.fading = !0) : lt(e, O), t.tooltipping = !1
                }, 1e3)), this
            },
            toggle: function () {
            ...
            return function (t, i, e) {
                ...
                value: function () {
                    ...
                    if (!t[p]) {
                        ...
                        } else pt(t, C, this.onStart = function (t) {
                            var i = t.target;
                ...
                value: function () {
                    if (!this.ready) {
                        ...
                        if (this.parent = i, this.viewer = n, this.title = s, this.toolbar = o, this.navbar = a, this.button = r, this.canvas = l, this.footer = n.querySelector(".".concat(p, "-footer")), this.tooltipBox = n.querySelector(".".concat(p, "-tooltip")), this.player = n.querySelector(".".concat(p, "-player")), this.list = n.querySelector(".".concat(p, "-list")), ht(s, h.title ? kt(Array.isArray(h.title) ? h.title[0] : h.title) : k), ht(a, h.navbar ? kt(h.navbar) : k), ct(r, k, !h.button), h.backdrop && (ht(n, "".concat(p, "-backdrop")), h.inline || "static" === h.backdrop || ft(l, K, "hide")), $(h.className) && h.className && h.className.split(U).forEach(function (t) {
                            ...
                            u || ht(o, kt(h.toolbar)), nt(u ? h.toolbar : Z, function (t, i) {
                                ...
                                if (s && (h.zoomable || -1 === d.indexOf(n)) && (h.rotatable || -1 === m.indexOf(n)) && (h.scalable || -1 === f.indexOf(n))) {
                                    ...
                                    r.setAttribute("role", "button"), ht(r, "".concat(p, "-").concat(n)), et(a) || ft(r, K, n), G(s) && ht(r, kt(s)), -1 !== ["small", "large"].indexOf(o) ? ht(r, "".concat(p, "-").concat(o)) : "play" === n && ht(r, "".concat(p, "-large")), et(a) && pt(r, C, a), c.appendChild(r)
                                }
                            }), o.appendChild(c)
                        } else ht(o, k);
                        if (!h.rotatable) {
                        ...
                        h.inline && (this.render(), this.bind(), this.isShown = !0), this.ready = !0, et(h.ready) && pt(t, P, h.ready, {
                            once: !0
                        }), !1 !== wt(t, P) ? this.ready && h.inline && this.view(this.index) : this.ready = !1
                    }
                }
            }], [{
                key: "noConflict",
    ...
    return st(Ct.prototype, Dt, Tt, Et, It, Ot), Ct
});