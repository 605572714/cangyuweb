! function (t, e) {
    ...
    return function (t) {
        ...
        function N(t, e, i, n) {
            void 0 === n && (n = !1), I.d || t.addEventListener(e, i, !!B && {
                capture: !1,
                passive: n
            })
        }
        ...
        function R(t, e, i, s) {
            ...
            return Object(I.b)(e.duration) && (r.animationDuration = e.duration + "s"), t("transition", {
                attrs: {
                    name: "van-fade"
                }
            }, [t("div", o()([{
        ...
        function Y() {
            if (_ || (_ = f(H, {
                ...
                var t = C.top,
                    ...
                    i = t.config,
                    s = e.$el;
                s && s.parentNode ? s.parentNode.insertBefore(_.$el, s) : document.body.appendChild(_.$el), n(_, W, i, {
                    show: !0
                })
            } else _.show = !1
        }
        ...
        var _t = Pt({
                ...
                data: function () {
                    return {
                        offset: 0,
                        duration: 0,
                        options: zt(this.initialOptions),
            ...
            de = ce({
                ...
                methods: {
                    ...
                    genWordLimit: function () {
                        var t = this.$createElement;
                        if (this.showWordLimit && this.maxlength) return t("div", {
                            class: he("word-limit")
        ...
        function zi(t, e, i, n) {
            ...
            return t("div", o()([{
                ...
                class: [Ei("title"), "van-multi-ellipsis--l2"]
            }, [e.title]) : void 0, i.desc ? i.desc() : e.desc ? t("div", {
                class: [Ei("desc"), "van-ellipsis"]
            ...
            Ss = ys({
                ...
                render: function () {
                    var t, e = this,
                        ...
                        o = this.animated,
                        r = this.scrollable,
                        a = this.children.map(function (t, o) {
                            return i(us, {
                                ref: "titles",
                                refInFor: !0,
                                attrs: {
            ...
            Ts = ws({
                ...
                render: function () {
                    ...
                    return e("div", {
                        ...
                        attrs: {
                            size: "large",
                            text: this.closeButtonText || Os("close")
                        },
                        class: Cs("close"),
                        on: {
                            click: a(-1)
        ...
        var Ls = (new Date).getFullYear(),
            Es = (0, Object(r.a)("date-picker")[0])({
                mixins: [js],
                props: n({}, Bs, {
                    type: {
                        type: String,
            ...
            Ms = zs[1],
            Fs = Ds({
                props: n({}, Ns.props, {}, Es.props),
                render: function () {
                    var t = arguments[0],
                        e = "time" === this.type ? Ns : Es;
                    return t(e, {
                        class: Ms(),
                        props: n({}, this.$props),
                        on: n({}, this.$listeners)
        ...
        var Hs = Vs(_s),
            ...
            wo = So({
                ...
                methods: {
                    ...
                    onTouchMove: function (t) {
                        this.touchable && this.swiping && (this.touchMove(t), this.isCorrectDirection && (E(t, this.stopPropagation), this.move({
                            offset: this.delta
                        })))
                    },
                    onTouchEnd: function () {
        ...
        var Ao, Lo = Bo({
                ...
                render: function () {
                    var t = arguments[0];
                    if (this.value) return t("transition", {
                        attrs: {
                            name: "van-fade"
                        }
                    }, [t("div", {
                        class: [jo(), this.className]
            ...
            zo = function (t, e) {
                if (void 0 === e && (e = 0), !I.d) {
                    Ao || (Ao = new(l.a.extend(Lo))({
                        el: document.createElement("div")
                    }), document.body.appendChild(Ao.$el), Ao.$on("change", function (t) {
                    ...
                    onScroll: function () {
                        ...
                        if (!os(this.$el)) {
                            ...
                            if (this.activeAnchorIndex = this.indexList[s], this.sticky) {
                                var o = 0,
                                    r = !1; - 1 !== s && (o = n[s].top - e - this.stickyOffsetTop, r = o <= 0), this.children.forEach(function (e, n) {
            ...
            Go = Xo({
                ...
                methods: {
                    ...
                    genLoading: function () {
                        ...
                        }, [this.loadingText || Qo("loading")])])
                    },
                    genFinishedText: function () {
                        var t = this.$createElement;
                        if (this.finished && this.finishedText) return t("div", {
                            class: Ko("finished-text")
                        }, [this.finishedText])
                    },
        ...
        function mr(t) {
            ...
            })), t = n({}, mr.currentOptions, {}, (e = t, Object(I.c)(e) ? e : {
                message: e
            })), n(fr, t), clearTimeout(dr), t.duration && t.duration > 0 && (dr = setTimeout(mr.clear, t.duration)), fr
        }
        ...
        function Hr(t, e, i, n) {
            ...
            return t("div", {
                ...
                class: _r(e.errorInfo ? "error-info" : "info")
            }, [r])])
        }
        Hr.props = {
            info: String,
        ...
        function Ia(t, e, i, n) {
            ...
            return t("div", o()([{
                ...
                for (var i, n = [], s = e.rowWidth, o = 0; o < e.row; o++) n.push(t("div", {
                    class: Oa("row"),
                    style: {
                        width: Object(it.a)((i = o, s === Ta && i === e.row - 1 ? $a : Array.isArray(s) ? s[i] : s))
                    }
                }));
                return n
            }()])])
        ...
        var Ha = Va(_a),
            ...
            Za = (0, Object(r.a)("sku-row-item")[0])({
                ...
                computed: {
                    choosable: function () {
                        return Qa(this.skuList, this.selectedSku, {
                            key: this.skuKeyStr,
                    ...
                    genPreviewItem: function (t, e) {
                        var i = this,
                            ...
                            o = pl(t) ? n(ht, {
                                ...
                                class: [gl("file-name"), "van-ellipsis"]
            ...
            Vl = Dl({
                ...
                computed: {
                    ...
                    stockText: function () {
                        ...
                        return e ? e(this.stock) : [Fl("stock") + " ", t("span", {
                            class: Ml("stock-num", {
                                highlight: this.stock < this.stockThreshold
                            })
                        }, [this.stock]), " " + Fl("stockUnit")]
                    },
                    quotaText: function () {
                ...
                render: function () {
                    ...
                    if (!this.isSkuEmpty) {
                        var i = this.sku,
                            ...
                            }, [this.priceTag])]), f("sku-header-origin-price") || o && e(Fa, [Fl("originPrice"), " ￥", o]), !this.hideStock && e(Fa, [e("span", {
                                class: "van-sku__stock"
                            }, [this.stockText]), !c && this.quotaText && e("span", {
                                class: "van-sku__quota"
                            }, ["(", this.quotaText, ")"])]), this.hasSku && !this.hideSelectedText && e(Fa, [this.selectedText]), f("sku-header-extra")]),
        ...
        var Rl = Vl,
            ...
            Kl = Ul({
                ...
                render: function () {
                    ...
                    return e("div", {
                        class: [b, Xl([o, (t = {}, t[i] = i, t)])]
                    }, [e("div", {
                        class: Xl("title"),
                        style: r
                    }, [this.slots()]), e("div", {
                        class: Xl("circle-container")
        ...
        function su(t, e, i, n) {
            ...
            return t("div", o()([{
                ...
                if ("number" == typeof r) {
                    ...
                    return t("div", {
                        class: iu("text")
                    }, [t("span", [e.label || nu("label")]), t("span", {
                        class: iu("price")
            ...
            uu = au({
                ...
                methods: {
                    ...
                    open: function (t) {
                        ...
                        this.swipeMove(e), this.opened = !0, this.$emit("open", {
                            position: t,
                            detail: this.name
                        })
                    },
                    ...
                    onClick: function (t) {
                        void 0 === t && (t = "outside"), this.$emit("click", t), this.opened && !this.lockClick && (this.onClose ? this.onClose(t, this, {
                            name: this.name
                        }) : this.swipeMove(0))
                    },
